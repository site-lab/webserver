...
if [ -e /etc/redhat-release ]; then
    ...
    if [ $DIST = "redhat" ];then
      if [ $DIST_VER = "8" ];then
        ...
        echo "dnf -y install git gcc gcc-c++ make libxml2-devel openssl-devel sqlite-devel bzip2-devel libcurl-devel libpng-devel libjpeg-turbo-devel libicu-devel readline-devel libxslt-devel libzip-devel autoconf"
        echo "dnf --enablerepo=powertools install -y oniguruma-devel"
        echo "libtidy-5.6.0-5.el8.x86_64.rpm"
        echo "libtidy-devel-5.6.0-5.el8.x86_64.rpm"
        dnf -y install git gcc gcc-c++ make libxml2-devel openssl openssl-devel sqlite-devel bzip2-devel libcurl-devel libpng-devel libjpeg-turbo-devel libicu-devel readline-devel libxslt-devel libzip-devel autoconf
        dnf --enablerepo=powertools install -y oniguruma-devel
        wget https://download-ib01.fedoraproject.org/pub/epel/8/Everything/x86_64/Packages/l/libtidy-5.6.0-5.el8.x86_64.rpm
        wget https://download-ib01.fedoraproject.org/pub/epel/8/Everything/x86_64/Packages/l/libtidy-devel-5.6.0-5.el8.x86_64.rpm
        rpm -Uvh libtidy-5.6.0-5.el8.x86_64.rpm
        rpm -Uvh libtidy-devel-5.6.0-5.el8.x86_64.rpm
        end_message
